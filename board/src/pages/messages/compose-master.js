            ...
            >
                    ...
                    loading ? (
                      ...
                      <fieldset>
                        ...
                        <Label block htmlFor="service">
                          <p>
                            Enter a topic, department name, or any other keyword
                          </p>
                        ...
                        <AutocompleteWrapper>
                          <Autocomplete
                            ...
                            getItemValue={item =>
                              item.service
                                ? `${item.service.name} - ${item.agency.name}`
                                : `${item.agency.name}`
                            }
                            renderMenu={(items, value, style) => {
                              ...
                              return <Services style={style} children={items} />
                            }}
                            renderItem={(item, active) => {
                              ...
                              return (
                                <ServiceC key={item.service.id} active={active}>
              ...
              <fieldset>
                ...
                <Label block htmlFor="content">
                  <p>
                    Please include any and all details relevant to your enquiry
                  </p>
